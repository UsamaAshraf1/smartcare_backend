...
import { getMedicalRecords, getMedications, getAllergies, getDiagnoses, getVitals, getLabResults, syncFaceVitalsRecord, syncUniteRecords, } from '../controllers/medicalRecordController.js';
const router = Router();
