...
import {
  ...
  listFaceScans,
  getFaceScanResults,
  listBusinessVitalsLinks,
  getBusinessVitalsLink,
  listBusinessVitalsScans,
  getBusinessVitalsScan,
  listBusinessVitalsTemplates,
  getBusinessVitalsTemplate,
} from '../controllers/faceVitalsController.js';
